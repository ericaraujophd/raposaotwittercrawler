...
class StdOutListener(StreamListener):
    ...
    def __init__(self, api = None):
        ...
        self.db = mdb.create_db(self.connect_db,'RaposaocomPhD')
    ...
    def on_data(self, data):
        try:
            ...
            # Fixing time zone and including the time of the tweet in Brazil.
            data_json['created_at'] = datetime.datetime.now()
